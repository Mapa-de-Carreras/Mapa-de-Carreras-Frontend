...
import PaginaDesignaciones from '@designaciones/designaciones/PaginaDesignaciones'
...
import PaginaEstadisticas from '@estadisticas/PaginaEstadisticas'
import Reportes from '@estadisticas/Reportes'

import PaginaDocumentos from '@documentos/PaginaDocumentos'
import AgregarDocumentos from '@documentos/AgregarDocumentos'
import DetalleDocumentos from '@documentos/DetalleDocumentos'
import EditarDocumentos from '@documentos/EditarDocumentos'
					...
					children: [
						...
						{ path: 'notificaciones', Component: NotificacionesPage, menu: false, },
						{
							...
							children: [
								...
								{ path: 'carreras/detalle/:id', label: 'Carrera', headerkey: 'carreras/detalle', Component: DetallesCarrera, menu: false },
								{ path: 'carreras/agregar', label: 'Agregar Carrera', headerkey: 'carreras/agregar', Component: AgregarCarrera, menu: false },
								{ path: 'carreras/editar/:id', label: 'Editar Carrera', headerkey: 'carreras/editar', Component: EditarCarrera, menu: false },
								{ path: 'asignaturas', label: 'Asignaturas', headerkey: 'asignaturas', icon: 'icon-[octicon--book-16]', Component: PaginaAsignaturas, menu: true, },
								{ path: 'asignaturas/detalle/:id', label: 'Asignatura', headerkey: 'asignaturas/detalle', Component: DetallesAsignatura, menu: false },
								{ path: 'asignaturas/agregar', label: 'Agregar Asignatura', headerkey: 'asignaturas/agregar', Component: AgregarAsignatura, menu: false },
								{ path: 'asignaturas/editar/:id', label: 'Editar Asignatura', headerkey: 'asignaturas/editar', Component: EditarAsignatura, menu: false },
								...
								{ path: 'planes/detalle', label: 'Plan de Estudio', headerkey: 'planes/detalle', Component: PlanEstudioDetalle, menu: false },
